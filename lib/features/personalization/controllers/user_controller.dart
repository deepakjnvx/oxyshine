...
import 'package:oxyshine/features/personalization/screens/profile/widgets/re_authenticate_user_login_form.dart';
...
class UserController extends GetxController {
  ...
  void deleteAccountWarningPopup() {
    Get.defaultDialog(
        ...
        middleText:
            'Are you sure you want to delete your account permanently? This action is not reversible and all of your data will be removed pemanently!',
      ...
      if (provider.isNotEmpty) {
        ...
        if (provider == 'google.com') {
          ...
          TLoaders.successSnackBar(
              ...
              message:
                  'We\'re sad😒 to see you leave, but hope to welcome you back soon in the future!');
